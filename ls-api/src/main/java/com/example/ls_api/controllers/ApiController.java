...
import com.example.ls_api.model.dto.DeleteEntityResponse;
...
public class ApiController {
    ...
    public ResponseEntity<DeleteEntityResponse> deleteShortLink(
            @PathVariable("id") String id) {

        urlService.deleteLinkById(id);

        return ResponseEntity.ok().body(new DeleteEntityResponse("Link deleted successfully"));
    }
